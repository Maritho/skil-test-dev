  ...
  return (
    <div className="flex flex-col gap-1">
      ...
      <div className="relative">
        <input type={type === 'password' ? (passwordVisible ? "text" : "password") : type} value={value} onChange={onChange} className="border border-[#CBCAD7] w-full h-[56px] p-4 outline-indigo-500 rounded-[12px] outline-none text-2xl font-bold placeholder:text-[#2F2F2F] placeholder:font-bold" />
